...
";
    ...
    fn committed_arm9_table_parses() {
        ...
        // chunk-table pins (45 code + 2 data) of Phase 4 step 4, then the
        // field data table pin (sMapHeaders) of Phase 5.
        assert_eq!(table.pins().len(), 65, "17 math pins + 47 save pins + 1 field pin");
