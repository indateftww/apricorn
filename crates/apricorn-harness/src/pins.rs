...
";
    ...
    fn committed_arm9_table_parses() {
        ...
        // field data table pin (sMapHeaders) and the field-movement
        // pins (25 code + gMovementCmdTable) of Phase 5.
        assert_eq!(table.pins().len(), 91, "17 math + 47 save + 1 field + 26 movement pins");
